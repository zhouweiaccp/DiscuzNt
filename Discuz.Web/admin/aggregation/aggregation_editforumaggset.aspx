	...
	<cc1:datagrid id="websiteconfig" runat="server" ColumnSpan="5">
		<Columns>
			<asp:TemplateColumn HeaderText=""><itemstyle width="8%" />
				<ItemTemplate>
					<a href="<%# GetEditLink(DataBinder.Eval(Container, "DataItem.tid").ToString())%>">编辑</a>
				</ItemTemplate>
			</asp:TemplateColumn>
...
<p style="text-align:right;">
	<button class="ManagerButton" type="button" onclick="javascript:window.location.href='<%=returnlink%>';"><img src="../images/submit.gif" /> 返回</button>
</p>
...
<table width="100%">
	...
	<tr><td class="item_title" colspan="2">发帖人</td></tr>
	<tr>
		<td class="vtop rowform">
	...
	<tr><td class="item_title" colspan="2">发帖时间</td></tr>
	<tr>
		<td class="vtop rowform">
	...
	<tr><td class="item_title" colspan="2">内容</td></tr>
	<tr>
		<td class="vtop rowform">
